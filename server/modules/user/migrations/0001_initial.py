...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AccessTokens',
            fields=[
                ('token', models.TextField(primary_key=True, serialize=False, verbose_name='Токен')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('token', models.TextField(primary_key=True, serialize=False, verbose_name='Токен')),
                ('valid_to', models.DateTimeField(default=None, verbose_name='Действителен до')),
                ('access', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.accesstokens', verbose_name='Токен доступа')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Для пользователя')),
            ],
            options={
